...
const CartItem = ({ cartItem }) => {
  ...
  return (
    <article
      key={cartID}
      className="mb-12 flex flex-col gap-y-4 sm:flex-row flex-wrap border-b border-accent pb-6 last:border-b-0"
    >
      {/* IMAGE */}
      <img
        src={image}
      ...
      <div className="sm:ml-16 sm:w-48">
        ...
        {/* COMPANY */}
        <h4 className="mt-2 capitalize text-sm neutral-content">{company}</h4>
        {/* COLOR */}
        <p className="mt-4 text-sm capitalize flex items-center gap-x-2">
          color:
          <span
            className="badge bdge-sm"
